...
const config: Config = {
  ...
  customFields: {
    apiUrl: process.env.REACT_APP_API_URL || 'web-production-be1b.up.railway.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/Farzanakosar',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/Farzanakosar',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'Farzanakosar GitHub',
              href: 'https://github.com/Farzanakosar',
            },
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/farzana-kosar-2414b92b6/',
            },
          ],
        },
        {
